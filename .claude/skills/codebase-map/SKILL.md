...
| [What this repo runs on a host](../../../docs/architecture/shipped-runtime.md) | where the statusline line comes from, what the hooks do on every prompt and tool call, and why the two never touch | 2026-08-23 |
