...
|---|---|---|
| [The owned settings keys](../../../docs/reference/owned-settings-keys.md) | which sixteen keys install.sh takes over, which are deliberately left to the host, and which are actively deleted | 2026-08-17 |
