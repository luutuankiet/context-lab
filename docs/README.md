...
| [The skills collection](architecture/skills-collection.md) | where the distributed skills live, which bucket actually installs, and why no third-party skill is vendored here | 2026-08-17 |
