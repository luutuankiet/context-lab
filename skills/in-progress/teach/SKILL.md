---
name: teach
description: Turn a directory into a standing teaching workspace and learn one topic across many sessions, as short cited HTML lessons. Use when the user invokes /teach — this skill is user-invoked only, never reached for on the agent's own initiative.
---
